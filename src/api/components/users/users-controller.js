...
async function getUsers(request, response, next) {
  try {
    ...
    const sortParam = request.query.sort || 'email:asc'; // Default sorting by email in ascending order
    const searchQuery = request.query.search || '';

    // Parse sort parameter
    const [sortBy, sortOrder] = sortParam.split(':');

    // Fetch users from the service with pagination, sorting, and search
